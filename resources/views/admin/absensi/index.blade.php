                ...
                <div class="col-lg-4 col-md-4 mt-3">
                    <div class="ibox bg-success color-white widget-stat">
                        <div class="ibox-body">
                            ...
                            <div class="m-b-3">{{ $k->jurusan->nama_jurusan }}</div><a href="{{ route('admin.absensi-perkelas', ['kelas_id' => $k->nama_kelas]) }}" class="ti-arrow-right text-light widget-stat-icon"></a>
