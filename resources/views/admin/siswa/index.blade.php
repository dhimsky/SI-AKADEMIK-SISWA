                                    ...
                                    <div class="modal-body">
                                        <form action="" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" name="nama_siswa"
                                                            class="form-control @error('nama_siswa') is-invalid @enderror" value=""
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        <label class="required-label faded-label" for="tanggal_lahir">Tanggal Lahir</label>
                                                        <input type="date" name="tanggal_lahir"
                                                            class="form-control @error('tanggal_lahir') is-invalid @enderror" value=""
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" name="tanggal_lulusan"
