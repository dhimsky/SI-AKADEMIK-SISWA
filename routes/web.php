...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->middleware('CekUserLogin:1')->group(function () {
        ...
        Route::post('naikkelas/baru', [AdminSiswaController::class, 'naikKelas'])->name('naikkelas.baru');
        // ============================== NILAI ===========================================
        ...
        Route::get('nilai-perkelas/{kelas_id}', [AdminNilaiController::class, 'nilai_perkelas'])->name('nilai-perkelas');
        ...
        Route::delete('delete-absensi-perkelas/{id}', [AdminAbsensiController::class, 'delete'])->name('delete-absensi-perkelas');
